...
self.__precacheManifest = [
  ...
  },
  {
    ...
    "revision": "367c5b23cf909cbe85777a54967900e8"
  },
  {
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  pathname = pathname.replace(new RegExp(`^/scaleph-website`), ``)
  ...
  const offlineShell = `/scaleph-website/offline-plugin-app-shell-fallback/index.html`
